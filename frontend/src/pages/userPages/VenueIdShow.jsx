    ...
    <Navbar user={user} />
      <div className="max-w-6xl mx-auto p-6 mt-24">
        ...
        <div className="w-full my-10 text-center">
          <button
            className="bg-gradient-to-r from-[hsl(290,59%,70%)] via-[#9536a8] to-[#71227e] px-[200px] py-3 rounded-full text-lg font-medium hover:from-[#ab30c1] hover:via-[#9c27b4] hover:to-[#9345a3] transition-all text-white"
