...
const AddCatering = ({ Inputs }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_SERVER}/catering`, newEvent, {
        withCredentials: true,
      });
      setLoading(false);
      navigate("/services");
      toast.success("New Catering Services Successfully Added!");
    } catch (error) {
    ...
    <>
      <div className="flex">
        ...
        <div className="flex-[6]">
          ...
          <div>
            <div className="pl-10">
              <h1 className="text-[#4e4d4d] text-[30px]">Add New Ctering Services</h1>
            </div>
            <hr />
