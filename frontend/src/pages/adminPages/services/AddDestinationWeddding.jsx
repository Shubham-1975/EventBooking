...
const AddDestinationWeddding = ({ Inputs }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_SERVER}/destination`,
      ...
      setLoading(false);
      navigate("/services");
      toast.success("New Destination Wedding Successfully Added!");
    } catch (error) {
      console.log(error);
...
export default AddDestinationWeddding;
