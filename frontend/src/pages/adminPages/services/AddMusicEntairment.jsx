...
const AddMusicEntairment = ({ Inputs }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_SERVER}/music `, newEvent, {
        withCredentials: true,
      });
      setLoading(false);
      navigate("/services");
      toast.success("New Music Services Successfully Added!");
    } catch (error) {
    ...
    <>
      <div className="flex">
        ...
        <div className="flex-[6]">
          ...
          <div>
            <div className="pl-10">
              <h1 className="text-[#4e4d4d] text-[30px]">Add New Music & Entairment</h1>
            </div>
            <hr />
...
export default AddMusicEntairment;
