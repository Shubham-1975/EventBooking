...
const AddBeachWedding = ({ Inputs }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const newBeachWedding = {
        ...info,
        photos: list,
      };
      await axios.post(`${import.meta.env.VITE_SERVER}/beach`, newBeachWedding, {
        withCredentials: true,
      });
      setLoading(false);
      navigate("/services");
      toast.success("New Beach Wedding Successfully Added!")
    } catch (error) {
      console.log(error)
    ...
    <>
      <div className="flex">
        ...
        <div className="flex-[6]">
          ...
          <div>
            <div className="pl-10">
              <h1 className="text-[#4e4d4d] text-[30px]">Add New Beach Wedding</h1>
            </div>
            <hr />
...
export default AddBeachWedding;
