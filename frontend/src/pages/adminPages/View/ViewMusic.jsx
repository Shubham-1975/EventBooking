...
const ViewMusic = () => {
  ...
  const [editableMusic, setEditableMusic] = useState({});

  useEffect(() => {
    if (data) {
      setMusic(data);
      setEditableMusic({ ...data });
    }
  }, [data]);
  const handleChange = (e) => {
    setEditableMusic((prev) => ({
      ...prev,
  ...
  if (!music) return <p className="text-center text-gray-600">Loading...</p>;
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="relative flex justify-center mb-4">
        {editableMusic?.photos?.length > 0 ? (
          <div className="relative">
            <img
              src={editableMusic.photos[0]}
              alt="music"
