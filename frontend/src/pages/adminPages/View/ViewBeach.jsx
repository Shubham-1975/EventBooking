...
const ViewBeach = () => {
  ...
  const [editableBeach, setEditableBeach] = useState({});

  useEffect(() => {
    if (data) {
      setBeach(data);
      setEditableBeach({ ...data });
    }
  }, [data]);

  const handleChange = (e) => {
    setEditableBeach((prev) => ({
      ...prev,
  ...
  if (!beach) return <p className="text-center text-gray-600">Loading...</p>;
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="relative flex justify-center mb-4">
        {editableBeach?.photos?.length > 0 ? (
          <div className="relative">
            <img
              src={editableBeach.photos[0]}
              alt="beach"
